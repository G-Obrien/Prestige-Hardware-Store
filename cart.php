            ...
            <div class="col-md-7">
                <div class="shopping-cart">
                    ...
                    if (isset($_SESSION['cart'])) {
                        ...
                        echo "<center><h3 class=\"text-warning\">No product added to cart yet..!</h3></center>";
                    }
                ...
                <div class="pt-4">
                    ...
                    <div class="row price-details">
                        ...
                        <div class="col-md-6">
                            ...
                            <h6>Sub Total: UGX <b><?php echo $total; ?></b>/=</h6>

                            <h6 class="text-success">3% per product.</h6>
                            <hr>
                        ...
                        <div class="col-md-12 text-center py-2">
                            <?php if ($total != 0) : ?>
                                <?php if (isset($_SESSION['username'])) : ?>
                                    <button type="submit" class="btn btn-warning mt-3"><a href="checkout.php" class="color-black">Proceed to Buy</a></button>
                                <?php else : ?>
                                    <button type="submit" class="btn btn-warning mt-3"><a href="signin.php" class="color-black"> &#8594;  Proceed to Buy</a></button>
                                <?php endif ?>
                            <?php else : ?>
                                <button type="submit" class="btn btn-warning mt-3\" disabled><a href="" class="color-black"> &#8594;  Proceed to Buy</a></button>
